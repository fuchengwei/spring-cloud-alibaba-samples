...
public enum PermissionTypeEnum {
     ...
     * 权限类型枚举
     */
    TYPE_DIRECTORY(1, "目录"), TYPE_MENU(2, "菜单"), TYPE_BUTTON(3, "按钮");
    ...
    static {
        Arrays.stream(PermissionTypeEnum.values()).forEach(permissionTypeEnum -> permissionTypeMap.put(permissionTypeEnum.code, permissionTypeEnum));
    }
