...
/**
 * @author fuchengwei
 * @date 2020/12/22 6:21 下午
 * @description Swagger聚合文档配置类
 */
@Primary
@Component
@AllArgsConstructor
public class DocumentationConfiguration implements SwaggerResourcesProvider {
    ...
    public List<SwaggerResource> get() {
        ...
        gatewayProperties
                ...
                .forEach(routeDefinition -> routeDefinition
                        ...
                        .forEach(predicateDefinition -> resources.add(swaggerResource(routeDefinition.getId(), predicateDefinition
                                .getArgs()
    ...
    private SwaggerResource swaggerResource(String name, String location) {
        ...
        swaggerResource.setSwaggerVersion("v1.0.0");
